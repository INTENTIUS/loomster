...
[Authenticated screen validation](/loomster/operations/production-live-e2e/#authenticated-screen-validation)).
See [Local caveats](/loomster/reference/local-caveats/).
