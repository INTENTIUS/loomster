---
title: Tutorial
description: Adopting Loom on chant — light tier on Floci, production/production-ha on real AWS, tier and topology selection, adoption seams, lifecycle Ops, and an honest positioning section.
---
...
[README](https://github.com/INTENTIUS/loomster/blob/main/README.md#components) for the full table.

Every physical name and cost-allocation tag traces back to one call —
`loomNaming(params, component)` in [`src/lib/naming.ts`](https://github.com/INTENTIUS/loomster/blob/main/src/lib/naming.ts)
...
[`src/composites/loom-cognito.ts`](https://github.com/INTENTIUS/loomster/blob/main/src/composites/loom-cognito.ts)) —
...
[`src/examples/byo/loom-cognito/`](https://github.com/INTENTIUS/loomster/tree/main/src/examples/byo/loom-cognito/) and
[`src/examples/byo/loom-cognito-second-instance/`](https://github.com/INTENTIUS/loomster/tree/main/src/examples/byo/loom-cognito-second-instance/)
...
[`.gitlab-ci.yml`](https://github.com/INTENTIUS/loomster/blob/main/.gitlab-ci.yml) straight from the same component
